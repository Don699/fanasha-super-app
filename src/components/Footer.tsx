  ...
  return (
    <>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-slate-400">
              <span className="flex items-start gap-2">
                ...
                Fanasha Divine Limited, Panting Abokobi Rd, Accra
              </span>
              <a href="tel:+233302555617" className="flex items-center gap-2 hover:text-amber-400 transition-colors">
                <Phone className="w-4 h-4 text-amber-400 shrink-0" /> Office: 030 255 5617
              </a>
              <a
                href="https://wa.me/233248643003"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 hover:text-emerald-400 transition-colors"
              >
                <MessageCircle className="w-4 h-4 text-emerald-400 shrink-0" /> WhatsApp: 024 864 3003
              </a>
              <a href="tel:+233257011272" className="flex items-center gap-2 hover:text-amber-400 transition-colors">
                <Phone className="w-4 h-4 text-amber-400 shrink-0" /> 025 701 1272
              </a>
              <a href="tel:+233257011224" className="flex items-center gap-2 hover:text-amber-400 transition-colors">
                <Phone className="w-4 h-4 text-amber-400 shrink-0" /> 025 701 1224
              </a>
            </div>
          </div>
        </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-emerald-500 hover:bg-emerald-400 hover:scale-105 rounded-full flex items-center justify-center shadow-lg shadow-emerald-500/30 transition-all"
      >
