      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/pawn-shop" className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-slate-950 font-semibold px-8 py-4 rounded-xl shadow-lg shadow-amber-500/20 text-base transition-all">
              Get Instant Cash Offer
              <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="/properties" className="inline-flex items-center border border-white/10 hover:bg-white/5 text-white px-8 py-4 rounded-xl text-base transition-all">
              Browse Properties
            </Link>
          </div>
        </div>
